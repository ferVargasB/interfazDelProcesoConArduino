#############################################################################
# Makefile for building: InterfazArduino.app/Contents/MacOS/InterfazArduino
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  InterfazArduino.pro
# Template: app
# Command: /Users/fernandovargas/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile InterfazArduino.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = InterfazArduino1.0.0
DISTDIR = /Users/fernandovargas/InterfazArduino/.tmp/InterfazArduino1.0.0
...
DIST          = ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		InterfazArduino.pro aplicacion.h main.cpp \
		aplicacion.cpp
QMAKE_TARGET  = InterfazArduino
DESTDIR       = 
TARGET        = InterfazArduino.app/Contents/MacOS/InterfazArduino
...
$(TARGET): ui_aplicacion.h $(OBJECTS)  
	@test -d InterfazArduino.app/Contents/MacOS/ || mkdir -p InterfazArduino.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: InterfazArduino.pro ../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile InterfazArduino.pro
...
InterfazArduino.app/Contents/PkgInfo: 
	@test -d InterfazArduino.app/Contents || mkdir -p InterfazArduino.app/Contents
	@$(DEL_FILE) InterfazArduino.app/Contents/PkgInfo
	@echo "APPL????" > InterfazArduino.app/Contents/PkgInfo
InterfazArduino.app/Contents/Resources/empty.lproj: 
	@test -d InterfazArduino.app/Contents/Resources || mkdir -p InterfazArduino.app/Contents/Resources
	@touch InterfazArduino.app/Contents/Resources/empty.lproj
	
InterfazArduino.app/Contents/Info.plist: 
	@test -d InterfazArduino.app/Contents || mkdir -p InterfazArduino.app/Contents
	@$(DEL_FILE) InterfazArduino.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.InterfazArduino,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,InterfazArduino,g" -e "s,@LIBRARY@,InterfazArduino,g" -e "s,@TYPEINFO@,????,g" ../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >InterfazArduino.app/Contents/Info.plist

all: Makefile \
		InterfazArduino.app/Contents/PkgInfo \
		InterfazArduino.app/Contents/Resources/empty.lproj \
		InterfazArduino.app/Contents/Info.plist $(TARGET)
...
distclean: clean 
	-$(DEL_FILE) -r InterfazArduino.app
...
moc_aplicacion.cpp: ../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QDialog \
		...
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/QtSerialPort \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qserialport.h \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qserialportglobal.h \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qserialportinfo.h \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qtserialportversion.h \
		aplicacion.h \
		../Qt/5.7/clang_64/bin/moc
	/Users/fernandovargas/Qt/5.7/clang_64/bin/moc $(DEFINES) -D__APPLE__ -D__GNUC__=4 -D__APPLE_CC__ -I/Users/fernandovargas/Qt/5.7/clang_64/mkspecs/macx-clang -I/Users/fernandovargas/InterfazArduino -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtGui.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/8.0.0/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I/usr/include -I'/System/Library/Frameworks (framework directory)' -I'/Library/Frameworks (framework directory)' -F/Users/fernandovargas/Qt/5.7/clang_64/lib aplicacion.h -o moc_aplicacion.cpp
